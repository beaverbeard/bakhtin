...
критический разбор, наблюдение-сцена. Смысл в том, чтобы **пять агентов
разошлись по жанрам, а не написали один и тот же текст пять раз.**

`free` направлений не имеет: перед генерацией оркестратор назначает N
**максимально различных форм** под конкретный материал (монолог / аналитика /
сцена / диалог / тезисы), по одной на агента — динамический аналог направлений
против схлопывания.
