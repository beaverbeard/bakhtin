...
это **не слово-роль** («пиши как эссеист»: от такой инструкции агент играет
клише), а **конкретный жанровый референс** с тремя частями: эталон + признаки
